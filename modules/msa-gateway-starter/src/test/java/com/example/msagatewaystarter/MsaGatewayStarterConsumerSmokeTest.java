...
@SpringBootTest(
        classes = MsaGatewayStarterConsumerSmokeTest.MsaGatewayApplication.class,
        properties = "jwt.secret=test-secret-key-that-is-at-least-32-characters-long"
)
@AutoConfigureMockMvc
class MsaGatewayStarterConsumerSmokeTest {
    ...
    @Test
    @DisplayName("MSA Gateway starter는 DB와 Token 발급 기능 없이 Access Token 검증만 구성한다")
    ...
    @Test
    @DisplayName("MSA Gateway starter는 유효한 JWT의 인증 주체를 Security Context에 저장한다")
    ...
    static class MsaGatewayApplication {
    }
